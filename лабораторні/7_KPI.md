...
- У налаштуваннях `Good Quantity` і `Rejected Quantity` виставте всі налаштування відповідно рис.7.3(1).
...
7) З використання модуля `Data Mining` відкрийте `Raw Data` для пакету `Progress WC_XX_PK106`. Проаналізуйте вміст. Те саме зробіть для інших створених Вами пакетів для робочого центру.
