...
2. Відкрийте налаштування `Effectiveness loss reasons` для робочого центру `WC_PK106_XX`. Створіть 4-ри причини втрати ефективності як це показано на рис.7.5(2). Поле `Code` залишайте без змін.
   - погано упаковане
   - недолив
