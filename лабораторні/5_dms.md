...
5) У вузлі означте умову `WC_Name = ""` це дає можливість визначити чи задано ім\'я робочого центру (рис.5.5(3)). Якщо ім\'я задано проводиться пошук робочого центру по імені, якщо немає - використовується ім\'я `WC_PAST1`. Замість `WC_PAST1` запишіть тут назву Вашого робочого центру. 
