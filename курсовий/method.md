...
![](G:\san\AKIT\ДИСЦИП\MES\GitVer\лекції\media\1.png)                               
...
- Розробка проекту автоматизованої системи керування операціями обслуговування обладнання *вказується виробництво*
...
- Розробка проекту автоматизованої системи керування операціями обслуговування обладнання цементного виробництва.
...
- кількістю і типом робочих місць та обладнання для виконання виробничих операцій в межах вибраного цеху, тобто робочих центрів
...
На рівні MES/MOM класичними вузлами є комп'ютери та комунікаційне обладнання. Комп'ютери використовуються як для виконання серверних застосунків і для робочих станцій. У даній курсовій роботі увага приділяється саме ПЗ рівня MES/MOM, тому комп'ютери для виконання інших завдань в структурі КТС можуть не показуватися.     
...
Таблиця 1. Відомість мережних технічних засобів (фрагмент.
...
У даному розділі необхідно навести переліки сегментів процесів та їх опис. У описі необхідно вказати назви сегментів процесів, їх опис та перелік параметрів. Приклад сегментів процесів наведений в таблиці 2.

Таблиця 2. Приклад сегментів процесів
...
Таблиця 4. Вузли та зони зберігання
...
Принцип обміну показаний на прикладі EQ_PAST1 для пастеризаційної установки (рис.7). Зв'язок з обладнанням пастеризаційної установки здійснюється з використанням OPC UA. 

![](G:\san\AKIT\ДИСЦИП\MES\GitVer\курсовий\media\3.png) 

рис.7. Схема з'єднання з ПЛК 

Таблиця 6. Перелік параметрів для EQ_PAST1
...
![](G:\san\AKIT\ДИСЦИП\MES\GitVer\курсовий\media\6.png)
...
У даному розділі необхідно навести перелік сегментів продукту з їх описом. Також варто навести структуру очікуваних продуктів у вигляді схеми, наприклад так, як показано на рис.9. При цьому треба вказувати 

![image-20220607172200288](media/image-20220607172200288.png)

рис.9. Орієнтовна схема для відображення звязки сегментів продукту. 



Таблиця 7. Опис сегментів продуктів
...
Після здачі проекту на перевірку, назначається час захисту. Команда захищає проект разом, однак починає за
